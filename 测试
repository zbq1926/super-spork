...
const authToken = '00000000-0000-4000-8000-000000000001';
let fallbackAddress = '210.61.97.241:81';
...
<a href="https://github.com/" target="_blank" style="color:#00ff00;text-decoration:none;margin:0 20px;font-size:1.2rem;text-shadow:0 0 5px #00ff00">GitHub 项目</a>
</div>
</div>
</div>
<script>
